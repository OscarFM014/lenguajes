...
public class GUIFrame extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, 92,
                                                Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jTextField7, javax.swing.GroupLayout.PREFERRED_SIZE, 92,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(52, 52, 52)));
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout
                                        ...
                                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
                                                Short.MAX_VALUE)
                                        .addComponent(jLabel8, javax.swing.GroupLayout.DEFAULT_SIZE, 185,
                                                Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(31, 31, 31)
                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 196,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 210,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(26, 26, 26))
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
    ...
    private boolean validateInputs() {
        ...
        while (!allRight) {
            ...
            if (jTextField1.getText().length() > 0 && Integer.parseInt(jTextField1.getText()) < 1
                    || Integer.parseInt(jTextField1.getText()) > 10) {
            ...
            if (Integer.parseInt(jTextField3.getText()) < 0 || Integer.parseInt(jTextField2.getText()) > 10000) {
                JOptionPane.showMessageDialog(rootPane,
                        "En 'Productores/Tiempo de Espera' ingrese solo números entre 0 y 10,000 ");
                return false;
            }

            if (Integer.parseInt(jTextField2.getText()) < 1 || Integer.parseInt(jTextField3.getText()) > 10) {
                JOptionPane.showMessageDialog(rootPane,
                        "En 'Consumidores/Cantidad' ingrese solo números entre 1 y 10 ");
                return false;
            }

            if (Integer.parseInt(jTextField4.getText()) < 0 || Integer.parseInt(jTextField4.getText()) > 10000) {
                JOptionPane.showMessageDialog(rootPane,
                        "En 'Consumidores/Tiempo de Espera' ingrese solo números entre 0 y 10,000 ");
                return false;
            }
            ...
            if ((Integer.parseInt(jTextField6.getText()) < 0 || Integer.parseInt(jTextField6.getText()) > 9)
